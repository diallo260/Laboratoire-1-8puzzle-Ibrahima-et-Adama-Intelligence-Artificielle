...
|---|---|---|---|
| Ex1-1 (20 coups) | 20 — 0,762 s | 2 698 — 0,045 s | 20 — 1,850 s |
| Ex1-2 (17 coups) | 17 — 0,182 s | 65 971 — 1,193 s | 17 — 0,395 s |
| Ex1-3 (insoluble) | échec — 2,186 s | échec — 2,113 s | échec — 48,447 s |
| Ex1-4 (28 coups) | 28 — 2,109 s | 64 830 — 1,218 s | 28 — 25,281 s |
...
- Discussion sur le temps : moins tranché que je ne l'imaginais. Le DFS met 0,045s sur Ex1-1,
il explore seulement 2 775 états avant de trouver l’objectif, ce qui explique son faible temps d’exécution.
Sur Ex1-2 il devient six fois plus lent que le BFS. Le BFS est le plus stable. L'IDDFS est le plus lent sur trois entrées sur quatre, ce qui
est logique puisqu'il recommence à chaque limite : 48 secondes sur Ex1-3, où il
épuise les 31 limites sans jamais trouver. Seule exception, sur Ex1-2 il reste plus rapide que le DFS,
car la solution est peu profonde alors que le DFS s'égare dans un chemin de 65 971 coups.
